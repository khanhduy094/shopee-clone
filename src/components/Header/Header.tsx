    ...
    <div className='bg-[linear-gradient(-180deg,#f53d2d,#f63)] pb-5 pt-2'>
      <div className='container'>
        <div className='flex justify-end'>
          <Popover
            renderPopover={
              <div className='relative rounded-sm border border-t-0 border-gray-200 bg-white shadow-sm'>
                <div className='flex flex-col py-2 px-3'></div>
                <div className='cursor-pointer  py-2 px-3 hover:text-orange'>Tiếng Việt</div>
                <div className='cursor-pointer py-2 px-3 hover:text-orange'>English</div>
              </div>
            }
            className='flex cursor-pointer items-center text-xs text-white hover:text-white/70 md:text-base'
          >
            <svg
          ...
          {isAuthenticated && (
            <Popover
              className='ml-1 flex cursor-pointer items-center text-xs text-white hover:text-white/70 md:text-base'
              renderPopover={
        ...
        <div className='mt-4 grid grid-cols-12 items-end gap-4'>
          ...
          <div className='col-span-1 justify-self-start text-white'>
            <Popover
              ...
              renderPopover={
                <div className='relative max-w-[400px] rounded-sm border border-t-0 border-gray-200 bg-white text-sm shadow-md'>
                  {purchasesInCart && purchasesInCart.length > 0 ? (
                        ...
                        {purchasesInCart.slice(0, MAX_PURCHASES).map((item) => (
                          <div className='mt-2 flex py-2 hover:bg-gray-100' key={item._id}>
                            ...
                            <div className='ml-2 flex-shrink-0'>
                              <span className='text-orange'>₫{formatCurrency(item.price)}</span>
                            </div>
                          </div>
                        ))}
                      </div>
                    ...
                    <div className='flex h-[300px] w-[300px] flex-col items-center justify-center p-2'>
                      <img src={noproduct} alt='' className='h-24 w-24' />
