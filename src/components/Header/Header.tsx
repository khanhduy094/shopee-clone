                ...
                <div className='relative max-w-[400px] rounded-sm border border-t-0 border-gray-200 bg-white text-sm shadow-md'>
                  {!isOpen ? (
                      ...
                      <div className='mt-5'>
                        ...
                        <div className='mt-2 flex py-2 hover:bg-gray-100'>
                          <div className='flex-shrink-0'>
                            <img src='/' alt='name' className='h-11 w-11 object-cover' />
                          </div>
                          <div className='ml-2 flex-grow overflow-hidden'>
                            <div className='truncate'>Ten sp</div>
                          </div>
                          <div className='ml-2 flex-shrink-0'>
                            <span className='text-orange'>₫10000</span>
                          </div>
                        </div>
                      </div>
                    ...
                    <div className='flex h-[300px] w-[300px] flex-col items-center justify-center p-2'>
                      <img src='/' alt='' className='h-24 w-24' />
