...
export default function Cart() {
  ...
  const totalPayment = checkedPurchases.reduce((result, current) => {
    return result + current.product.price * current.buy_count
  }, 0)
  //số tiền tiết kiệm dc
  const totalSavePrice = checkedPurchases.reduce((result, current) => {
          ...
          <div className='mt-5 flex flex-col sm:ml-auto sm:mt-0 sm:flex-row sm:items-center'>
            <div>
              <div className='flex items-center sm:justify-end'>
                ...
                <div className='ml-2 text-2xl text-orange'>₫{formatCurrency(totalPayment)}</div>
              </div>
              <div className='flex items-center text-sm sm:justify-end'>
                <div className='text-gray-500'>Tiết kiệm</div>
                <div className='ml-6 text-orange'>₫{formatCurrency(totalSavePrice)}</div>
              </div>
            </div>
            <Button
